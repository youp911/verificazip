...
uses
  ...
  Mask, numericos, UnContasApagar, Localizacao, UnClassesImprimir, SqlExpr;
...
begin
  ...
  InseriLinhaSQL(MovParcelas, 0,
    ...
    ' CPM.N_VLR_PAG, CPM.C_NRO_CON, CPM.C_NRO_DOC, CPM.L_OBS_REC, CPM.I_COD_FRM, CPM.N_VLR_ADI, ' +
