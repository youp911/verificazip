...
begin
  result := true;
  if (VprDCheque.TipFormaPagamento = 'R') or
     (VprDCheque.TipFormaPagamento = 'C') then
  begin
    result := false;
    ...
    begin
      ...
      begin
        result := true;
        if VprDCheque.TipFormaPagamento = 'R' then
        begin
          result := false;
          begin
...
begin
  ...
  if (VprDCheque.TipFormaPagamento <> 'R') then // cheque de terceiros não permite alterar o vencimento
  begin
...
begin
  ...
  begin
    ...
    begin
      ...
      if VprDCheque.TipFormaPagamento = 'R' Then //CHEQUES DE TERCEIRO
