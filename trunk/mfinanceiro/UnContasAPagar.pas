...
Type
  ...
  public
    ...
    procedure LocalizaParcelasComParciais(tabela : TDataSet; lancamento : Integer);
...
type
  ...
  public
    ...
    procedure DesativaDespesaFixa( lancamento : Integer );
    ...
    function VerificaSeGeraParcial(VpaDBaixa : TRBDBaixaCP;VpaValAReceber : Double) : String;
    ...
    function EstornoParcela(VpaCodFilial, VpaLanPagar,VpaNumParcela, VpaNumParcelaFilha : integer;VpaVerificarCheques : Boolean) : String;
...
procedure TLocalizaContasAPagar.LocalizaParcelasComParciais(tabela : TDataSet; lancamento : Integer);
begin
  AdicionaSQLAbreTabela(tabela,
    ' select * from MovContasaPagar ' +
    ' where i_lan_apg = ' + IntToStr(Lancamento) +
...
{************** desativa despesa fixa ************************************** }
procedure TFuncoesContasAPagar.DesativaDespesaFixa( lancamento : Integer );
var
  desativa : TSQLQUERY;
begin
  ExecutaComandoSql(Tabela,' UPDATE CADCONTASAPAGAR SET ' +
                           ' C_FLA_DES = ''N''' +
                           ' , D_ULT_ALT = '+ SQLTextoDataAAAAMMMDD(DATE) +
                           ' WHERE I_EMP_FIL = ' + IntToStr(Varia.CodigoEmpFil) +
                           ' AND I_LAN_APG = '   + IntToStr(lancamento));
end;
...
{******************************************************************************}
function TFuncoesContasAPagar.VerificaSeGeraParcial(VpaDBaixa : TRBDBaixaCP;VpaValAReceber : Double) : String;
var
  VpfLaco : Integer;
  VpfDParcela : TRBDParcelaCP;
begin
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          result := EstornoParcela(VpfDParcela.CodFilial,VpfDParcela.LanPagar,VpfDParcela.NumParcela,VpfDParcela.NumParcelaParcial,false);
          if result <> '' then
            break;
        end;
      end;
...
{******************************************************************************}
function TFuncoesContasAPagar.EstornoParcela(VpaCodFilial, VpaLanPagar,VpaNumParcela, VpaNumParcelaFilha : integer;VpaVerificarCheques : Boolean) : String;
var
