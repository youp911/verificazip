...
uses
  ...
  EditorImagem, ImgList, numericos, FMTBcd, SqlExpr;
...
begin
  ...
  if (TDados(arvore.Selected.Data).Codigo <> EditLocaliza1.Text)and (EditLocaliza1.Text <> '') then
  begin
    SomaNivel := 1;
    NivelSelecao := 1;
...
{******************************************************************************}
procedure TFPlanoConta.ArvoreDblClick(Sender: TObject);
begin
