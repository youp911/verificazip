...
begin
  ...
  MovComissoes.Sql.add(' from MovComissoes MOC, CadVendedores CV, CadContasaReceber CAR, CADCLIENTES CLI, MOVCONTASARECEBER MOV ' +
...
begin
  SubstituiLinhaSQL(MovComissoes, MovComissoes.sql.count-1,' order by CV.C_NOM_VEN, MOV.C_NRO_DUP');
  MovComissoes.close;
  MovComissoes.open;
  InicializaRave;
