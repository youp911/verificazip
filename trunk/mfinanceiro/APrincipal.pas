...
uses
  ...
  UnProspect, WideStrings, DBXOracle, SqlExpr;
...
type
  TFPrincipal = class(TFormularioFundo)
    ...
    IndicadorDesempenho1: TMenuItem;
    N17: TMenuItem;
...
uses
  ...
  AConsultaDespesas, AConsultaTitulosDespesas,
...
//             FFluxoCaixa.free;
    ...
    5400 : begin
             FDER := TFDER.criarSDI(Application,'',FPrincipal.VerificaPermisao('FDER'));
             FDER.DERMensal(mes(date),ano(date));
             FDER.free;
           end;
    6100 : begin
  ...
  30100 : begin
            FIndicadorInadimplencia := tFIndicadorInadimplencia.CriarSDI(self,'',FPrincipal.VerificaPermisao('FIndicadorInadimplencia'));
            FIndicadorInadimplencia.ShowModal;
            FIndicadorInadimplencia.free;
          end;
  30200 : begin
