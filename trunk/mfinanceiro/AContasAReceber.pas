...
type
  TFContasaReceber = class(TFormularioPermissao)
    ...
    numerico2: Tnumerico;
    MovNotasC_NRO_CHE: TWideStringField;
...
begin
   ...
   FNovoContasAReceber.NovoContasAReceber;
...
begin
  ...
  begin
    ...
    BPagamento.Enabled := MovParcelasD_DAT_PAG.IsNull; // Só pode pagar as ão pagas;
    if MovParcelasI_EMP_FIL.AsInteger <> varia.CodigoEmpFil then
      AlterarEnabledDet([BPagamento,BAlterar],false);
