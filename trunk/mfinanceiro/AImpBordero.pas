...
type
  ...
  private
    ...
    procedure CarregaImpressao(VpaCodFilial,VpaNumBordero : String);
  ...
  public
    { Public declarations }
    procedure VisualizaBordero(VpaCodFilial,VpaNumBordero : String);
  end;
...
{************************** carrega a impressão *******************************}
procedure TFImpBordero.CarregaImpressao(VpaCodFilial,VpaNumBordero : String);
begin
  PosicionaBordero(VpaCodFilial,VpaNumBordero);
  AtualizaTotais(VpaCodFilial,VpaNumBordero);
  LBordero.Caption := 'Bordero '+ VpaNumBordero;
end;
...
procedure TFImpBordero.VisualizaBordero(VpaCodFilial,VpaNumBordero : String);
begin
  CarregaImpressao(VpaCodFilial,VpaNumBordero);
