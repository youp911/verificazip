...
uses APrincipal,Constantes, FunData, ConstMsg, AChequesCP, AFormasPagamento;
...
begin
  ...
  if result = '' then
  begin
    result := FunContasAPagar.VerificaSeGeraParcial(VprDBaixaCP,EValPago.AValor);
    if result = '' then
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        EValPago.AValor := FunContasAPagar.RValTotalCheques(VprDBaixaCP);
