...
begin
  ...
  ExecutaComandoSql(aux,'Update CADTRANSPORTADORAS SET COD_CIDADE = NULL');
  ...
  begin
    ...
    begin
      ...
      LStatus.Refresh;
      ExecutaComandoSql(Aux,'insert into CAD_CIDADES(COD_CIDADE,COD_ESTADO,COD_PAIS,DES_CIDADE,COD_FISCAL) Values('+
                            IntTostr(VpfCodigo)+','''+VpfUF+''',''BR'','''+VpfNomCidade+''','''+VpfCodigoFiscal+''')');
    end;
  end;
