...
type
  TFPrincipal = class(TFormularioFundo)
    ...
    MFTransferenciaProduto: TMenuItem;
...
uses Constantes, UnRegistro, funsql,
...
begin
  ...
  begin
    ...
    if (puImpressao in varia.PermissoesUsuario) then
      AlterarVisibleDet([MImpDocumentos,MImprimirBoleto,MFImprimeCarne,Manual1,MFMostraEnvelope,MDuplicata,
                         MFMostraRecibo,MFMostraPromissoria,MFMostraCarne,MFMostraBoleto,MFMostraCheque,MFMostraduplicata],true);
    ...
    if (puFAGerarNota in varia.PermissoesUsuario) then
      AlterarVisibleDet([BMFNotaFiscal,BMFConsultaNotaFiscal, MCadastro,MFCadIcmsEstado,MAliquota,MFOperacoesEstoques,MFUnidades,N11,MFTransportadoras,N4,MVendedores,
                         MNotaFiscal,MNovanota,MFTransferenciaProduto,N5],true);
...
{      4015 : begin
               FTransferenciaProduto := TFTransferenciaProduto.CriarSDI(Application,'',Fprincipal.VerificaPermisao('FTransferenciaProduto'));
               FTransferenciaProduto.ShowModal;
               FTransferenciaProduto.free;
             end;}
      4510 : begin
               VerificaStatusSefaz;
             end;
