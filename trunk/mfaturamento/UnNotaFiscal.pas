...
begin
  ...
  if EntradaNumero( 'Número da Proxima Nota', 'Número da Proxima Nota', NroNota, false, clWhite, clSilver, false) then
...
begin
  ...
  begin
    ...
    try
      ...
      on e : exception do
      begin
        result := 'ERRO NA GRAVAÇÃO DOS ITENS DA NOTA FISCAL!!!'#13+e.message;
        exit;
      end;
    end;
  end;
...
begin
  ...
  begin
    ...
    try
      ...
      on e : exception do
      begin
        result := 'ERRO NA GRAVAÇÃO DOS SERVIÇOS DA NOTA FISCAL!!!'#13+e.message;
        exit;
      end;
    end;
  end;
...
//nfe
  ...
  repeat
    ...
    try
      ...
      on e :exception do
      begin
        result := 'ERRO NA GRAVAÇÃO DA NOTA FISCAL!!!'#13+e.message;
        VpaDNota.NumNota := RetornaProximoCodigoNota(VpaDNota.DesSerie)
      end;
    end;
    inc(VpfQtdGravacao);
