...
begin
  ...
  begin
    ...
    FunEMarketing.CarDTarefaEMarkegting(VprDTarefa,TarefaEMarketingSEQTAREFA.AsInteger);
    FunEMarketing.EnviaEMarketingCliente(VprDTarefa,LStatus,BarraProgresso);
