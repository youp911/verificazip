...
uses APrincipal, ANovoFaturamentoMensal, Constantes, FunSql, FunData;
...
begin
  ...
  ContratoProcessado.sql.add(SQLTextoDataEntreAAAAMMDD('CON.DATPROCESSADO',EDataInicial.Datetime,EDataFinal.DateTime,true));
...
begin
  ...
  begin
    if ((config.ImprimirEnvolopeSomentecomNotaFatMensal) and (ItensProcessadosC_NRO_NOT.AsString <> '')) or
      ...
      FunCrystal.ImprimeRelatorioDiretoImpressora(varia.ImpressoraRelatorio, Varia.PathRelatorios+ '\Clientes\XX_Envelope.rpt',[ItensProcessadosI_COD_CLI.AsString,ItensProcessadosCODFILIAL.AsString],opPaisagem );
