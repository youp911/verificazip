...
uses APrincipal, FunObjeto,Fundata, FunString, ConstMsg, FunSql;
...
begin
  ...
  VprDLeitura.ValTotal := VprDContrato.ValContrato + (VprDLeitura.QtdExcedente * VprDContrato.ValExcedenteFranquia)+ (VprDLeitura.QtdExcednteColor * VprDContrato.ValExcedenteColorido);
