...
uses
  ...
  Mask, unPedidoCompra, UnDadosProduto, FMTBcd, DBClient, SqlExpr;
...
begin
  ...
  ProdutosComContrato.Sql.add('Select CON.CODFILIAL, CON.SEQCONTRATO, '+
                              ' TIP.NOMTIPOCONTRATO, '+
...
{******************************************************************************}
procedure TFNovoTeleMarketing.PosItensProposta(VpaSeqProposta: Integer);
begin
...
begin
  ...
  if FAlteraEstagioProposta.AlteraEstagioPropostaCliente(PROPOSTASSEQPROPOSTA.AsInteger) then
    PosPropostas(ECodCliente.AInteiro);
...
begin
  VpfFunPedidoCompra := TRBFunPedidoCompra.Cria(FPrincipal.BaseDados);
  VpfFunPedidoCompra.ConsultaNotasFiscais(PEDIDOCOMPRACORPOSEQPEDIDO.AsInteger);
  VpfFunPedidoCompra.free;
end;
