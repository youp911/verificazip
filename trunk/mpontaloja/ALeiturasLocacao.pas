...
uses
  ...
  ComCtrls, Localizacao, Mask, numericos, Graficos, FMTBcd, SqlExpr, DBClient;
...
begin
  ...
  begin
    ...
    dtRave.ImprimeExtratoLocacao(LocacaoCODFILIAL.AsInteger,LocacaoSEQLEITURA.AsInteger);
    dtRave.free;
