...
type
  ...
  public
    { Public declarations }
    procedure ConsultaBaixasParciais(VpaCodFilial,VpaLanOrcamento : Integer);
  end;
...
uses APrincipal, AImpCotacao, ConstMsg, UnCrystal,Constantes, UnClientes,
  dmRave, FunSql;
...
begin
  ...
  OrcamentoParcialCorpo.Sql.Add('Select ORC.CODFILIAL, ORC.LANORCAMENTO, ORC.SEQPARCIAL, '+
...
{******************************************************************************}
procedure TFConsultaBaixaParcial.BEnviarClick(Sender: TObject);
begin
  FunCrystal.EnviaEmail(Varia.PathRelatorios+ '\Cotações\XX_Cotação Parcial email.rpt',FunClientes.REmailCliente(FunCotacao.RCodCliente(OrcamentoParcialCorpoCODFILIAL.AsInteger,OrcamentoParcialCorpoLANORCAMENTO.AsInteger)),'Pedido Parcial "'+OrcamentoParcialCorpoLANORCAMENTO.AsString+'" - ' +Varia.NomeFilial,[OrcamentoParcialCorpoCODFILIAL.AsString,OrcamentoParcialCorpoLANORCAMENTO.AsString,OrcamentoParcialCorpoSEQPARCIAL.AsString]);
end;
