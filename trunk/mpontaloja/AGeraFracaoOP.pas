...
begin
  if varia.TipoOrdemProducao = toAgrupada then
    FunCrystal.ImprimeRelatorioDiretoImpressora(Varia.ImpressoraRelatorio,varia.PathRelatorios+'\Ordem Produção\1000ESPO_Ordem Producao Agrupada.rpt',[IntToStr(VprDOrdemProducao.SeqOrdem),intToStr(VprDOrdemProducao.CodEmpresafilial)])
  else
...
begin
  if varia.TipoOrdemProducao = toAgrupada then
    FunCrystal.ImprimeRelatorioDiretoImpressora(Varia.ImpressoraRelatorio,varia.PathRelatorios+'\Ordem Produção\XX_ConsumoOrdemProducao.rpt',[intToStr(VprDOrdemProducao.CodEmpresafilial),IntToStr(VprDOrdemProducao.SeqOrdem)])
end;
