...
uses
  ...
  Tabela, DBTables, CheckLst, UnDados, UnLembrete;
...
type
  TFSelecionarUsuarios = class(TFormularioPermissao)
    ...
    Label1: TLabel;
    CADUSUARIOS: TQuery;
    CADUSUARIOSI_COD_USU: TIntegerField;
    CADUSUARIOSI_COD_GRU: TIntegerField;
    CADUSUARIOSC_NOM_USU: TStringField;
...
begin
  ...
  FunLembrete:= TRBFuncoesLembrete.Cria;
  CADGRUPOS.Open;
