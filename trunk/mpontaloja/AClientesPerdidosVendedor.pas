...
uses APrincipal, FunData, AnovoClientePerdidoVendedor, FunSql, unCrystal, Constantes;
...
begin
  if ClientePerdidoSEQPERDIDO.AsInteger <> 0 then
    FunCrystal.ImprimeRelatorio(varia.PathRelatorios+'\Clientes\XX_ClientesPerdidosPorVendedor.rpt',[ClientePerdidoSEQPERDIDO.AsString]);
end;
...
begin
  if ClientePerdidoSEQPERDIDO.AsInteger <> 0 then
    FunCrystal.ImprimeRelatorio(varia.PathRelatorios+'\Clientes\XX_ClientesPerdidosPorCliente.rpt',[ClientePerdidoSEQPERDIDO.AsString]);
end;
