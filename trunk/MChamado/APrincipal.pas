...
begin
  FMostraPlanejamentoOP := TFMostraPlanejamentoOP.CriarSDI(application,'', FPrincipal.VerificaPermisao('FMostraPlanejamentoOP'));
  FMostraPlanejamentoOP.ShowModal;
  FMostraPlanejamentoOP.free;
end;
