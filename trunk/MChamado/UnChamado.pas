...
begin
  ...
  VpaTexto.add('  </tr><tr>');
  VpaTexto.add('<td width="25%" bgcolor="#'+varia.CRMCorClaraemail+'"><font face="Verdana" size="1"><b>&nbsp;Previsão Atendimento</td><td width="30%" bgcolor="#'+varia.CRMCorEscuraemail+'"><font face="Verdana" size="2">&nbsp;'+FormatDateTime('DD/MM/YYYY - HH:MM:SS',VpaDChamado.DatPrevisao)+'</td>');
  VpaTexto.add('<td width="10%" bgcolor="#'+varia.CRMCorClaraemail+'"><font face="Verdana" size="1"><b>&nbsp;Usuário</td><td width="35%" bgcolor="#'+varia.CRMCorEscuraemail+'"><font face="Verdana" size="2">&nbsp;'+Sistema.RNomUsuario(VpaDChamado.CodUsuario) +'</td>');
  VpaTexto.add('  </tr>');
  VpaTexto.add('</table>');
  VpaTexto.add('    <br>');
  ...
  begin
    ...
    VpaTexto.add('	<td width="20%" bgcolor="#'+varia.CRMCorClaraemail+'" align="center"><font face="Verdana" size="-2">&nbsp;Numero Série </td>');
  ...
  VpaTexto.add('</table>');
  VpaTexto.add('Serviços Prestados');
  VpaTexto.add('<hr>');
  VpaTexto.add('<hr>');
  VpaTexto.add('<hr>');
  VpaTexto.add('<hr>');
  ...
  VpaTexto.add('	<td width="25%" bgcolor="#'+varia.CRMCorClaraemail+'"><font face="Verdana" size="1"><b>&nbsp;Valor Peças</td>');
...
begin
  ...
  try
    ...
    on e : exception do result := 'ERRO NA GRAVAÇÃO DO CHAMADO CORPO!!!'#13+ e.message;
  end;
  Cadastro.close;
  if result = '' then
  begin
  ...
  begin
    ...
    begin
      ...
      try
        ...
        on E:Exception do
        begin
          Result:= 'ERRO NA GRAVAÇÃO DOS PRODUTOS ORÇADOS!!!'#13+E.Message;
          Break;
        end;
      end;
    end;
