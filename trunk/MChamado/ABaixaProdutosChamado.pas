...
begin
  ...
  if GProdutosChamado.Cells[1,GProdutosChamado.ALinha] <> '' then
    VprDProdutoChamado.QtdABaixar := StrToFloat(DeletaChars(GProdutosChamado.Cells[1,GProdutosChamado.ALinha],'.'))
  else
    VprDProdutoChamado.QtdABaixar := 0;

  if VprDProdutoChamado.QtdABaixar > (VprDProdutoChamado.QtdProduto - VprDProdutoChamado.QtdBaixado) then
  begin
