...
begin
  ...
  begin
    ...
    try
      ...
      on e : exception do
      begin
        result := 'ERRO NA GRAVAÇÃO DO CAIXAITEM!!!'#13+e.message;
        break;
      end;
    end;
  end;
...
begin
  ...
  begin
    ...
    try
      ...
      on e : exception do result := 'ERRO NA GRAVAÇÃO DA TABELA CAIXAFORMAPAGAMENTO!!!'+#13+e.message;
    end;
    if result <> '' then
    break;
  end;
...
begin
  ...
  try
    ...
    on e : exception do result := 'ERRO NA ATUALIZAÇÃO DO SALDO DA CONTA CAIXA!!!'#13+e.message;
  end;
  Cadastro.close;
end;
...
begin
  ...
  try
    ...
    on e : exception do result := 'ERRO NA GRAVAÇÃO DO SEQUENCIAL DO CAIXA NO CADCONTAS!!!'#13+e.message;
  end;
  Cadastro.close;
end;
...
begin
  ...
  try
    ...
    on e : exception do result := 'ERRO NA GRAVAÇÃO DO CAIXACORPO!!!'+#13+e.message;
  end;
  Cadastro.close;
