...
uses
  ...
  ANovoCaixa in 'ANovoCaixa.pas' {FNovoCaixa},
  UnCaixa in 'UnCaixa.pas',
  ...
  ACaixas in 'ACaixas.pas' {FCaixas},
  AFechamentoCaixa in 'AFechamentoCaixa.pas' {FFechamentoCaixa},
  ...
  ANovaTransferencia in 'ANovaTransferencia.pas' {FNovaTransferencia},
