...
begin
  try
    ...
    begin
      ...
      Financeiro.Visible := ExisteLetraString('A',VpfLinha);
      BPontoLoja.Visible := ExisteLetraString('B',VpfLinha);
      BChamadoTecnico.Visible := ExisteLetraString('C',VpfLinha);
      BFaturamento.Visible := ExisteLetraString('E',VpfLinha);
      BEstoqueCusto.Visible := ExisteLetraString('D',VpfLinha);
      BCRM.Visible := ExisteLetraString('F',VpfLinha);
      BCaixa.Visible := ExisteLetraString('G',VpfLinha);
