...
implementation
uses
  FunData, FunSql, ANovaTarefaEMarketingProspect, APrincipal;
...
begin
  ...
  begin
    ...
    FunEmarketingProspect.CarDTarefaEMarkegting(VprDTarefa,TarefasSEQTAREFA.AsInteger);
    FunEmarketingProspect.EnviaEMarketingProspect(VprDTarefa,LStatus,LNomeContaEmail,LQtdEmail, BarraProgresso);
