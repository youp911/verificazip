...
{******************************************************************************}
procedure TFNovoTelemarketingProspect.AlterarEstgio1Click(Sender: TObject);
begin
  FAlteraEstagioProposta := TFAlteraEstagioProposta.CriarSDI(self,'',FPrincipal.VerificaPermisao('FAlteraEstagioProposta'));
  if FAlteraEstagioProposta.AlteraEstagioProposta(PROPOSTASSEQPROPOSTA.AsInteger) then
    PosPropostas(Ligacoes.FieldByname('CODPROSPECT').AsInteger);
