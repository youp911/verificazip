...
begin
    case Msg.CharCode  of
      ...
      119 :
       begin
       if not VerificaFormCriado('TFAlteraEstagioProposta') then
       begin
         FAlteraEstagioProposta := TFAlteraEstagioProposta.criarSDI(Application,'',FPrincipal.VerificaPermisao('FAlteraEstagioProposta'));
         FAlteraEstagioProposta.AlteraEstagioProposta;
