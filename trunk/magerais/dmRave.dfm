object dtRave: TdtRave
  ...
  object Principal: TSQL
    ...
    ASqlQuery.SQL.Strings = (
        ...
        'SELECT AGE.CODUSUARIO, AGE.CODCLIENTE, AGE.DATCADASTRO, AGE.DATI' +
        'NICIO DATA, AGE.DATINICIO, AGE.DATFIM, AGE.INDREALIZADO,'
      '   AGE.DESOBSERVACAO,'
      '   CLI.C_NOM_CLI,'
      '   USU.C_NOM_USU, '
      ...
      ''
        ...
        'FROM AGENDA AGE, CADCLIENTES CLI, CADUSUARIOS USU, TIPOAGENDAMEN' +
        'TO TIP, CADUSUARIOS USA'
      ...
      'AND CODUSUARIO = 15'
      'ORDER BY USU.C_NOM_USU, AGE.DATINICIO')
