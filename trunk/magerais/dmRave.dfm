object dtRave: TdtRave
  ...
  object Principal: TSQL
    ...
    ASqlQuery.SQL.Strings = (
        ...
        'select VEN.C_NOM_VEN, CLI.C_NOM_CLI, SUM(MOV.N_VLR_TOT) VALPRODU' +
        'TO, SUM(MOV.N_QTD_PRO) QTDPRODUTO,COUNT(DISTINCT(CAD.I_COD_CLI))' +
        'QTDCLIENTE,  COUNT(DISTINCT(MOV.I_SEQ_PRO))PRODUTOS'
      ' '
      ...
      'GROUP BY VEN.C_NOM_VEN, CLI.C_NOM_CLI'
      'order by 1, 2')
