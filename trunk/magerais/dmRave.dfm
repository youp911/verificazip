object dtRave: TdtRave
  ...
  object Principal: TSQL
    ...
    ASqlQuery.SQL.Strings = (
        ...
        'Select  LEI.CODFILIAL, LEI.SEQLEITURA, LEI.DATLEITURA, LEI.VALTO' +
        'TALDESCONTO, LEI.QTDCOPIA, '
      
        ' LEI.QTDDEFEITO, LEI.QTDEXCEDENTE, LEI.QTDCOPIACOLOR, LEI.QTDFRA' +
        'NQUIACOLOR, '
      
        ' LEI.QTDEXCEDENTECOLOR, LEI.VALEXECESSOFRANQUIA,LEI.VALEXECESSOF' +
        'RANQUIACOLOR,'
      
        ' CLI.I_COD_CLI, CLI.C_NOM_CLI,  CLI.C_NOM_FAN, CLI.C_END_CLI, CL' +
        'I.I_NUM_END, '
      
        ' CLI.C_COM_END, CLI.C_BAI_CLI, CLI.C_CEP_CLI, CLI.C_CID_CLI, CLI' +
        '.C_EST_CLI, CLI.C_CGC_CLI, '
      ' CLI.C_INS_CLI, CLI.C_FO1_CLI, CLI.C_FON_FAX, CLI.C_END_ELE , '
      ' CON.QTDFRANQUIA '
      
        ' from LEITURALOCACAOCORPO LEI, CADCLIENTES CLI, CONTRATOCORPO CO' +
        'N '
      ' Where LEI.CODCLIENTE = CLI.I_COD_CLI '
      ' AND LEI.CODFILIAL = CON.CODFILIAL '
      ' AND LEI.SEQCONTRATO = CON.SEQCONTRATO '
      ' AND LEI.CODFILIAL = 11'
      ' AND LEI.SEQLEITURA = 13')
