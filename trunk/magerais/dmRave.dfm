object dtRave: TdtRave
  ...
  object Principal: TSQL
    ...
    ASqlQuery.SQL.Strings = (
      'select CLA.C_COD_CLA, CLA.C_NOM_CLA, '
      ...
      ' FRA.CODFILIAL, FRA.SEQORDEM, FRA.SEQFRACAO '
        ...
        ' from CADCLASSIFICACAO CLA, CADPRODUTOS PRO, CADPRODUTOS MP, FRA' +
        'CAOOP FRA, IMPRESSAOCONSUMOFRACAO IMP '
