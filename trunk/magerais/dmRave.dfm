object dtRave: TdtRave
  ...
  object Principal: TSQL
    ...
    ASqlQuery.SQL.Strings = (
        ...
        'select CLI.I_COD_CLI, CLI.C_NOM_CLI, CLI.C_END_CLI, CLI.C_BAI_CL' +
        'I, CLI.C_CEP_CLI, CLI.C_EST_CLI, CLI.C_CID_CLI,'
      
        '       CLI.C_REG_CLI, CLI.C_CPF_CLI, CLI.C_CGC_CLI, CLI.C_INS_CL' +
        'I, CLI.C_TIP_PES, CLI.I_NUM_END, CLI.C_PRA_CLI,'
      
        '      CLI.C_END_COB, CLI.I_NUM_COB, CLI.C_BAI_COB, CLI.C_CEP_COB' +
        ', CLI.C_CID_COB, CLI.C_EST_COB, '
      
        '      CAD.D_DAT_EMI, CAD.I_NRO_NOT, CAD.I_QTD_PAR, CAD.N_VLR_TOT' +
        ', '
      
        '      MOV.I_EMP_FIL, MOV.I_LAN_REC, MOV.I_NRO_PAR, MOV.D_DAT_VEN' +
        ', MOV.N_VLR_PAR,'
      '     MOV.C_NRO_DUP '
      
        'FROM CADCLIENTES CLI, CADCONTASARECEBER CAD, MOVCONTASARECEBER M' +
        'OV'
      'WHERE CAD.I_COD_CLI = CLI.I_COD_CLI'
      'AND CAD.I_EMP_FIL = MOV.I_EMP_FIL'
      'AND CAD.I_LAN_REC = MOV.I_LAN_REC'
      'AND MOV.I_EMP_FIL = 11'
      'AND MOV.I_LAN_REC = 123'
      'AND MOV.I_NRO_PAR = 1')
