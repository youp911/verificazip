object dtRave: TdtRave
  ...
  object Principal: TSQL
    ...
    ASqlQuery.SQL.Strings = (
      'select BAS.LARBASTIDOR, BAS.ALTBASTIDOR,  CLI.C_NOM_CLI,  '
      'PRO.C_NOM_PRO,  MAP.C_COD_PRO CODMATPRIMA, '
      'MAP.C_NOM_PRO NOMMATPRIMA,  ENT.C_COD_PRO CODENTRETELA,'
      ' ENT.C_NOM_PRO NOMENTRETELA,  TER.C_COD_PRO CODTERMOCOLANTE,'
      ' TER.C_NOM_PRO NOMTERMOCOLANTE,  COR.NOM_COR, '
      ' COM.NOM_COR CORMATPRIMA,  FAC.NOMFACA,  FAC.ALTFACA,'
      ' FAC.LARFACA, FAC.QTDPROVA,  MAQ.NOMMAQ,  OCI.CODMAQUINA,'
      ' OCI.CODFACA, OCI.DESOBSERVACAO, OCI.LARMOLDE, OCI.ALTMOLDE, '
      'OCI.QTDPRODUTO,  OCI.SEQTERMOCOLANTE, OCI.SEQENTRETELA,'
      ' OCI.QTDTERMOCOLANTE, OCI.QTDENTRETELA,  OCI.CODBASTIDOR,'
      ' OCI.QTDPECASBASTIDOR, OCI.LARENFESTO, OCI.ALTENFESTO, '
      'OCI.QTDENFESTO, OCI.POSFACA, ORD.EMPFIL, ORD.SEQORD, '
      'ORD.DATEMI, ORD.DATENP, ORD.CODPRO, ORD.CODCOM,'
      ' ORD.DESOBS,  ORD.UNMPED, ORD.QTDORP, ORD.QTDFRA  '
      ''
      'from ORDEMCORTEITEM OCI, ORDEMPRODUCAOCORPO ORD, '
      'BASTIDOR BAS,  CADCLIENTES CLI, CADPRODUTOS PRO, '
      'CADPRODUTOS MAP, CADPRODUTOS ENT,          CADPRODUTOS TER, COR,'
      ' COR COM, FACA FAC, MAQUINA MAQ  '
      ''
      ...
      'AND   OCI.CODFACA = FAC.CODFACA (+)  '
      'AND   OCI.CODMAQUINA = MAQ.CODMAQ (+) '
      ' AND   OCI.SEQENTRETELA = ENT.I_SEQ_PRO (+) '
      ' AND   OCI.SEQTERMOCOLANTE = TER.I_SEQ_PRO (+) '
      ' AND   OCI.CODBASTIDOR = BAS.CODBASTIDOR (+)  '
