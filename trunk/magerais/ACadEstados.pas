...
type
  TFCadEstados = class(TFormularioPermissao)
    ...
    CadEstadosCOD_ESTADO: TWideStringField;
    CadEstadosCOD_PAIS: TWideStringField;
    CadEstadosDES_ESTADO: TWideStringField;
    BitBtn1: TBitBtn;
    CadEstadosDAT_ULTIMA_ALTERACAO: TSQLTimeStampField;
