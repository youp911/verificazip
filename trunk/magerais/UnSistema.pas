...
begin
  ...
  try
    ...
    on e : exception do result := 'ERRO NA GRAVAÇÃO DA TABELA RESUMOCUSTO!!!'#13+e.message;
  end;
  SisCadastro.close;
end;
  ...
  begin
    ...
    repeat
      ...
      try
        ...
        on e :exception do
        begin
          VpfResultado := 'ERRO NA GRAVAÇÃO DO LOG!!!'#13+e.message;
        end;
      end;
      inc(VpfQtdGravacao);
...
begin
  ...
  try
    ...
    on e : exception do result := 'ERRO NA GRAVAÇÃO DA TABELA CFG_GERAL!!!'+#13+e.message;
  end;
  SisCadastro.close;
end;
