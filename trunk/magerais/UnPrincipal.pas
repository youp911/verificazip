...
type
  ...
  public
    ...
    // caption
    procedure AlteraNomeEmpresa( FPrincipal : TFormularioFundo; Barra : TStatusBar; NomeMOdulo, TipoSistemaVersao  : String  );
...
procedure TFuncoesPrincipal.AlteraNomeEmpresa( FPrincipal : TFormularioFundo; Barra : TStatusBar; NomeMOdulo, TipoSistemaVersao  : String );
begin
   ...
   Barra.Panels[2].Text := ' Moeda : ' + dateToStr(varia.DataDaMoeda)
end;
