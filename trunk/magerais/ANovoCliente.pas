...
uses
  ...
  CGrades, UnProdutos, UnDadosLOcaliza, DBClient, FMTBcd, SqlExpr;
...
type
  TFNovoCliente = class(TFormularioPermissao)
    ...
    procedure DBEditLocaliza7Cadastrar(Sender: TObject);
    ...
    procedure DBEditLocaliza10Retorno(Retorno1, Retorno2: String);
    ...
    procedure DBEditLocaliza12Cadastrar(Sender: TObject);
...
{******************************************************************************}
procedure TFNovoCliente.DBEditLocaliza7Cadastrar(Sender: TObject);
begin
...
procedure TFNovoCliente.DBEditLocaliza10Retorno(Retorno1,
  Retorno2: String);
begin
  if (CadClientes.State in [dsInsert, dsEdit]) then
    if (Retorno1 <> '') then
...
{******************************************************************************}
procedure TFNovoCliente.DBEditLocaliza12Cadastrar(Sender: TObject);
begin
