...
uses
  ...
  AProdutosFornecedores in 'AProdutosFornecedores.pas' {FProdutosFornecedores},
  ...
  AImprimeTabela in 'AImprimeTabela.pas' {FImprimeTabela},
  ...
  AImpTabelaServico in 'AImpTabelaServico.pas' {FImpTabelaServico},
  ...
  AImprimeCodigoBarra in 'AImprimeCodigoBarra.pas' {FImprimeCodigoBarra},
  ALocalizaProdutos in '..\MFaturamento\ALocalizaProdutos.pas' {FlocalizaProduto},
  AImprimeEtiquetaBarra in 'AImprimeEtiquetaBarra.pas' {FImprimeEtiquetaBarra},
  ...
  AImprimeEstoqueProduto in 'AImprimeEstoqueProduto.pas' {FImprimeEstoqueProduto},
  AImprimeEstoqueClassificacao in 'AImprimeEstoqueClassificacao.pas' {FImprimeEstoqueClassificacao},
  ...
  AImpOrdemProducao in 'AImpOrdemProducao.pas' {FImpOrdemProducao},
  ...
  ANovoProdutoPro in 'ANovoProdutoPro.pas' {FNovoProdutoPro},
