...
uses APrincipal, Constantes,ConstMsg, AProdutosKit, 
...
begin
  if EFilial.Text <> '' then
    VpaSelect.add(' and Qtd.I_Emp_Fil = ' + EFilial.text);
  ...
  if CEstoqueNegativo.Checked then
    VpaSelect.add(' and Qtd.n_qtd_pro < 0 ');
end;
