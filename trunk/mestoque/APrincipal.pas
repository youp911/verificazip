...
type
  TFPrincipal = class(TFormularioFundo)
    ...
    N41: TMenuItem;
    ExcluiProdutoDuplicado1: TMenuItem;
...
begin
  ...
  begin
    if (puProdutoCompleto in varia.PermissoesUsuario) then
      AlterarVisibleDet([BMFProdutos,MProdutos,MFProdutos,n16,MFAdicionaProdFilial,N17,MFTabelaPreco,MFFormacaoPreco,n18,MFImprimeCodigoBarra,
                         n7,N19],true);
    if (puManutencaoProdutos in varia.PermissoesUsuario) then
      AlterarVisibleDet([BMFProdutos,MFProdutos,MProdutos,Cor1,Facas1],true);
    ...
    if (puESPedidoCompra in varia.PermissoesUsuario) then
      AlterarVisibleDet([MPedidosCompras,MNovoPedidoCompras,MCompras],true);
    if (puESSolicitacaoCompra in varia.PermissoesUsuario) then
      AlterarVisibleDet([MSolicitacaoCompras,MNovaSolicitacaoCompras,MSolicitacoesCompras,MAlteraEstagioOrcamentoCompra],true);
