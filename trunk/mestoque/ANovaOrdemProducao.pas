...
type
  ...
  TFNovaOrdemProducao = class(TFormularioPermissao)
    ...
    Label34: TLabel;
    Coleta: TQuery;
    ColetaDATCOL: TDateTimeField;
    ColetaINDFIN: TStringField;
    ColetaC_NOM_USU: TStringField;
    ColetaCODCOM: TIntegerField;
    ColetaNROFIT: TIntegerField;
    ColetaMETAPR: TFloatField;
    ColetaMETCOL: TFloatField;
    ColetaMETFAL: TFloatField;
    DataColeta: TDataSource;
    EPente: TEditColor;
    Label35: TLabel;
    ColetaCODMAN: TStringField;
    ...
    MetroFaturado: TQuery;
    DataMetroFaturado: TDataSource;
    MetroFaturadoI_NRO_NOT: TIntegerField;
    MetroFaturadoD_DAT_EMI: TDateField;
    MetroFaturadoT_HOR_SAI: TTimeField;
    MetroFaturadoCODCOM: TIntegerField;
    MetroFaturadoCODMAN: TStringField;
    MetroFaturadoMETCOL: TFloatField;
...
uses APrincipal,Constantes, FunData, ConstMsg, AMaquinas,
  ANovoCliente,FunObjeto, FunNumeros, AImpOrdemProducao, FunSql, FunString,
...
begin
  ...
  Coleta.Sql.SaveToFile('c:\consulta.sql');
  Coleta.Open;
end;
...
begin
  ...
  begin
    ...
    MetroFaturado.Sql.saveToFile('c:\Consulta.sql');
    MetroFaturado.Open;
  end;
end;
