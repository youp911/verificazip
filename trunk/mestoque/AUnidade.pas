...
uses
  ...
  DBGrids, StdCtrls, Mask, DBCtrls, DBKeyViolation, BotaoCadastro,
   Buttons, Localizacao, FunObjeto, DBClient, FMTBcd, SqlExpr;
...
type
  TFUnidades = class(TFormularioPermissao)
    ...
    CadUnidades2: TSQL;
    CadUnidades1: TSQL;
    MovIndiceConversao: TSQL;
    DataIndeceConversao: TDataSource;
    MovIndiceConversaoC_UNI_ATU: TWideStringField;
    MovIndiceConversaoC_UNI_COV: TWideStringField;
    MovIndiceConversaoN_IND_COV: TFMTBCDField;
    MovIndiceConversaoUnidadePai: TWideStringField;
    MovIndiceConversaoUnidadeFilho: TWideStringField;
    ...
    Label4: TLabel;
    CadUnidade: TSQL;
    CadUnidadeC_COD_UNI: TWideStringField;
    CadUnidadeC_NOM_UNI: TWideStringField;
    BFechar: TBitBtn;
    CadUnidadeD_ULT_ALT: TSQLTimeStampField;
    MovIndiceConversaoD_ULT_ALT: TSQLTimeStampField;
