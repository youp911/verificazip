...
uses
  ...
  ComCtrls, UnProdutos, Spin, DBKeyViolation, FMTBcd, SqlExpr, DBClient;
...
uses APrincipal, constantes, ConstMsg, AMontaKit, funsql, funstring, funObjeto,
  AImprimeTabela, ALocalizaProdutos, ALocalizaClassificacao,
  ANovoProdutoPro;
...
begin
  ...
  begin
    ...
    AlterarVisibleDet([RVenda,RCompra,Rcusto],false);
...
//  LocalizaEdit1.AOrdem := LocalizaEdit1.AOrdem + ' order by pro.c_bar_for';
...
var
  VpfValor : string;
begin
  if coluna in [0,5,6,7,8,9,10] then
  begin
    case coluna of
    0 : VpfValor := CadProdutos.fieldByname('C_COD_PRO').AsString;
    5 : VpfValor := CadProdutos.fieldByname('N_VLR_VEN').AsString;
    6 : VpfValor := CadProdutos.fieldByname('N_VLR_COM').AsString;
    7 : VpfValor := CadProdutos.fieldByname('N_VLR_CUS').AsString;
    8 : VpfValor := CadProdutos.FieldByName('N_VLR_REV').AsString;
    9 : VpfValor := CadProdutos.fieldByname('N_PER_MAX').AsString;
    10: VpfValor := CadProdutos.fieldByname('N_IND_MUL').AsString;
    end;
    ...
    begin
      ...
      case coluna  of
       0,10 :
        ...
        5,8,9: //valor de venda e percentual máximo
         begin
       ...
       6,7 : //valor de compra e de custo
         begin
...
begin
  ...
  Aux.SQl.Clear;
  Aux.Sql.Add(' update  movtabelapreco as tab' +
...
begin
  ...
  begin
    FunProduto.InserePrecoProdutoCliente(VpfSeqProduto,ECodTabela.Ainteiro,ECliente.Ainteiro,0);
    AtualizaConsulta(true);
  end;
