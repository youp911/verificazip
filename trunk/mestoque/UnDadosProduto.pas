...
type TRBDNotaFiscal = class
  public
    ...
    CodMotivoNFE,
    DesMotivoNFE,
    DesMotivoCancelamentoNFE : String;
    DatNSU,
    DatEmissao,
    DatSaida,
    HorSaida : TDateTime;
...
Type
  TRBDNotaFiscalForItem = class
    public
      ...
      PerIPI,
      PerICMS     : Double;
      IndMedicamentoControlado : Boolean;
      UnidadeParentes : TStringList;
      constructor cria;
      destructor destroy;override;
end;
...
{******************************************************************************}
function TRBDAmostra.addConsumo : TRBDConsumoAmostra;
begin
...
{******************************************************************************}
function TRBDAmostra.addServicoFixo : TRBDServicoFixoAmostra;
begin
