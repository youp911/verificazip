...
uses APrincipal,FunData, FunObjeto, ConstMsg, UnProdutos, ANovaFaccionista,
  ATerceiroFaccionista;
...
begin
  ...
  VprDFracaoFaccionista.DatCadastro := now;
  ...
  EUsuario.Atualiza;
  EData.Text := FormatDateTime('DD/MM/YYYY HH:MM:SS',VprDFracaoFaccionista.DatCadastro);
...
begin
  ...
  VprDRetornoFracao.DatCadastro := now;
  EUsuario.AInteiro := VprDRetornoFracao.CodUsuario;
  EUsuario.Atualiza;
  EData.Text := FormatDateTime('DD/MM/YYYY HH:MM:SS',VprDRetornoFracao.DatCadastro);
...
begin
  ...
  AlterarEnabledDet([EFilial,EOrdemProducao,EFracao,EIDEstagio,EFaccionista,SFilial,SOP,SFracao,SIdEstagio,SFaccionista],false);
...
begin
  ...
  FunOrdemProducao.CarValoreSeqItemFaccionista(EFilial.Ainteiro,EOrdemProducao.AInteiro,EFracao.AInteiro,
                                                                    EIDEstagio.AInteiro,EFaccionista.AInteiro,CDefeito.Checked,VprDRetornoFracao);
...
begin
  ...
  FTerceiroFaccionista.CadastraTerceiros(VprDRevisaoFracao);
